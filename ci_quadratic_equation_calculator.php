...
Version: 1.0.0
Author: Quadratic Equation Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Quadratic Equation Calculator by www.calculator.io";

function display_calcio_ci_quadratic_equation_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_quadratic_equation_calculator', 'display_calcio_ci_quadratic_equation_calculator' );